...
describe("Queries Across Tables", () => {
  ...
  it(
    ...
    async done => {
      ...
      group by full_name order by total_budget desc limit 3`;
  ...
  it(
    ...
    async done => {
      const query = `select count(*) as count, keywords.keyword as keyword from keywords
  ...
  it(
    ...
    async done => {
      ...
      where original_title = 'Life' order by count`;
  ...
  it(
    ...
    async done => {
      const query = `select round(avg(movie_ratings.rating), 2) as avg_rating, genres.genre as genre from movie_ratings
      inner join movie_genres on movie_ratings.movie_id = movie_genres.movie_id
