...
describe("Insert Relationship Data", () => {
  ...
  it(
    ...
    async done => {
      ...
      const genreRows = (await db.selectMultipleRows(`select genre, id from genres`)) as GenreRow[];
  ...
  it(
    ...
    async done => {
      const movies = await CsvLoader.movies();
      const actorRows = (await db.selectMultipleRows(`select full_name, id from actors`)) as ActorRow[];
      const moviesByImdbId = _.groupBy(await CsvLoader.movies(), "imdbId");
  ...
  it(
    ...
    async done => {
      ...
      const directorRows = (await db.selectMultipleRows(
        `select full_name, id from directors`
      )) as DirectorRow[];
      const moviesByImdbId = _.groupBy(await CsvLoader.movies(), "imdbId");
  ...
  it(
    ...
    async done => {
      const movies = await CsvLoader.movies();
      const keywordRows = (await db.selectMultipleRows(`select keyword, id from keywords`)) as KeywordRow[];
      const moviesByImdbId = _.groupBy(await CsvLoader.movies(), "imdbId");
  ...
  it(
    ...
    async done => {
      ...
      const productionCompanyRows = (await db.selectMultipleRows(
        `select company_name, id from production_companies`
